...
urlpatterns = [
    ...
    path('delete_session/<session_id>/', HodViews.delete_session, name="delete_session"),
     path(
        "current-session/", HodViews.CurrentSessionAndTermView.as_view(), name="current-session"
    ),
    ...
    path('attendance/Classes/',HodViews.attendance, name='attendance'),
    path('attendance/<int:cls_id>/Class/',HodViews.attendance_class, name='attendance_class'),
    path('attendance/<int:cls_id>/class/confirm/',HodViews.take_attendance, name='take_attendance'),
    ...
    path('student_leave_view/staff/', StaffViews.staff_student_leave_view, name="staff_student_leave_view"),

    # URSL for Student
    path('student_home/', StudentViews.student_home, name="student_home"),
    path('student_view_attendance/', StudentViews.student_view_attendance, name="student_view_attendance"),
    path('student_view_attendance_post/', StudentViews.student_view_attendance_post, name="student_view_attendance_post"),
    path('student_leave_app/', StudentViews.student_apply_leave, name="student_apply_leave"),
    path('student_leave_app_save/', StudentViews.student_apply_leave_save, name="student_apply_leave_save"),
