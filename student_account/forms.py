...
DeductionsItemFormset = inlineformset_factory(
    Staff, Staff_Deductions, fields=["deductions", "amt"], extra=1, can_delete=True
)

EarningsItemFormset = inlineformset_factory(
